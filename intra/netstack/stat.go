...
func stat(s *stack.Stack) (out *x.NetStat) {
	...
	out.IPStat.ErrSnd = out.IPStat.Snd - int64(ip.PacketsDelivered.Value())
	out.IPStat.ErrRcv = out.IPStat.Rcv - int64(ip.ValidPacketsReceived.Value())
	// ip forwarding
	...
	// udp
	out.UDPStat.ErrChecksum = int64(udp.ChecksumErrors.Value())
	out.UDPStat.ErrRcv = int64(udp.MalformedPacketsReceived.Value())
	out.UDPStat.ErrSnd = int64(udp.PacketsReceived.Value())
	...
	out.TCPStat.ErrChecksum = int64(tcp.ChecksumErrors.Value())
	...
	out.TCPStat.ErrRcv = int64(tcp.InvalidSegmentsReceived.Value())
	...
	out.TCPStat.ErrSnd = int64(tcp.SegmentSendErrors.Value())
